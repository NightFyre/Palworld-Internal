...
namespace DX11_Base 
{
    ...
    namespace Tabs 
    {
        ...
        void TABItemSpawner()
        {
            ...
            ImGui::Combo("Item Category", &category, "Accessories\0Ammo\0Armor\0Blueprints\0Crafting Materials\0Eggs\0Food\0Hats\0\Medicine\0Money\0Other\0Pal Spheres\0Seeds\0Tools\0Weapons\0");
